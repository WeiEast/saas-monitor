...
public class OperatorMonitorGroupAlarmServiceImpl implements OperatorMonitorGroupAlarmService {
    ...
    private String generateMailDataBody(List<TaskStatAccessAlarmMsgDTO> msgList, Date startTime, Date endTime, String baseTitle) {
    ...
    private String generateWeChatBody(List<TaskStatAccessAlarmMsgDTO> msgList, Date startTime, Date endTime, String baseTitle) {
        StringBuffer buffer = new StringBuffer();
