...
public class SaasErrorStepDayStatUpdateServiceImpl extends AbstractService implements SaasErrorStepDayStatUpdateService {
    ...
    public void batchInsertErrorDayStat(List<SaasErrorStepDayStatDTO> list) {
        List<SaasErrorStepDayStat> dataList = convert(list, SaasErrorStepDayStat.class);
