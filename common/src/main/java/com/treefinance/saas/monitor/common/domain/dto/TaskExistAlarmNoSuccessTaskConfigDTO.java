 ...
 */
public class TaskExistAlarmNoSuccessTaskConfigDTO implements Serializable {
    ...
    public static void main(String[] args) {
        List<TaskExistAlarmNoSuccessTaskConfigDTO> list = Lists.newArrayList();
        TaskExistAlarmNoSuccessTaskConfigDTO config1 = new TaskExistAlarmNoSuccessTaskConfigDTO();
        ...
        TaskExistAlarmNoSuccessTaskConfigDTO config2 = new TaskExistAlarmNoSuccessTaskConfigDTO();
