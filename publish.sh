...
# 4.upload
echo "upload web/target/monitor-web-1.0.0-SNAPSHOT.jar ..."
sshpass -p dashu0701 scp  web/target/monitor-web-1.0.0-SNAPSHOT.jar root@$server_ip:$server_application
