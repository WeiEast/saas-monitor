...
public class AlarmBasicConfigurationFacadeImplTest {
    ...
    public void addOrUpdate() {
        ...
        asAlarmInfoRequest.setName("测试预警配置");
        ...
        asAlarmVariableInfoRequest.setName("总转化率");
        ...
        asAlarmMsgInfoRequest.setBodyTemplate("【#{level}】您好，#{saasEnv}【所有环境】运营商监控(按人数统计)预警,在2018-07-09 03:00:00--2018-07-09 03:30:00时段数据存在问题，此时监控数据如下，请及时处理：\n" +
