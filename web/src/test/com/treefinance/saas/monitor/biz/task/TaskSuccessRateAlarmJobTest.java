...
public class TaskSuccessRateAlarmJobTest {
    ...
    public void execute() {
        ...
        //定时任务执行时间
        String dateStr = "2018-05-16 19:40:00";
...
//            String configStr = diamondConfig.getTaskSuccessRateAlarmConfig();
            String configStr = "[{\"alarmSwitch\":\"on\",\"intervalMins\":20,\"levelConfig\":[{\"channels\":[\"ivr\"," +
